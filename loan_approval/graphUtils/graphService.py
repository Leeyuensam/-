    ...
    def statExData(self, value):
        try:
            ...
            return {
                'is_blacklist': i[0],
                'history_score': i[1],
                'first_layer_blacklist_num': self.network1FlagNum(value=value),
                'second_layer_blacklist_num': self.network2FlagNum(value=value),
                'phone_num': self.userPhoneNum(value=value),
                'large_amount_transaction': self.userRmtNum(value=value),
                'default_loan_num': c1,
                'complete_loan_num': c2,
                'rejected_loan_num': c3,
            }
        except:
            return -1
